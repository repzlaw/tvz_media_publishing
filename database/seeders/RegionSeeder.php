...
class RegionSeeder extends Seeder
{
    ...
    public function run()
    {
        $regions = array(
            ...
            array("name"=> "land Islands", "code"=> "AX"),
            ...
            array("name"=> "Cocos array(Keeling) Islands", "code"=> "CC"),
            ...
            array("name"=> "Cote Divoire", "code"=> "CI"),
            ...
            array("name"=> "Falkland Islands array(Malvinas)", "code"=> "FK"),
            ...
            array("name"=> "Holy See array(Vatican City State)", "code"=> "VA"),
            ...
            array("name"=> "Korea, Democratic PeopleS Republic of", "code"=> "KP"),
            array("name"=> "Korea, Republic of", "code"=> "KR"),
            array("name"=> "Kuwait", "code"=> "KW"),
            array("name"=> "Kyrgyzstan", "code"=> "KG"),
            array("name"=> "Lao Peoples Democratic Republic", "code"=> "LA"),
        ...
        foreach ($regions as $value) {
            $user = Region::updateOrCreate($value);
        }
    }
}
